...
class DummyDataset(Dataset):
    def __init__(self, base_folder: str, num_samples=100000, width=1024, height=576, sample_frames=16):
        """
        Args:
...
def main():
    ...
    train_dataset = DummyDataset("/kaggle/input/anime-blue-lock/dataset", width=args.width, height=args.height, sample_frames=args.num_frames)
                        ...
                        with torch.autocast(
                            ...
                            for val_img_idx in range(args.num_validation_images):
                                ...
                                video_frames = pipeline(
                                    load_image('https://i.postimg.cc/Zqgs6Kgs/demp.webp').resize((args.width, args.height)),
                                    height=args.height,
                                    width=args.width,
